...
export const metadata: Metadata = {
    title: "Terms & Condition | Nexus Partners",
};
                ...
                <div className="container relative z-10">
                    <div className='flex flex-col gap-5'>
                        ...
                        <div className="bg-white dark:bg-dark_black p-8 rounded-2xl">
                            <p>
                                This Nexus Partners Terms of Service (“<span className="font-semibold">Agreement</span>”) is entered into by and between Nexus Partners (“<span className="font-semibold">Nexus Partners</span>”) and the entity or person placing an order for or accessing the Services (“<span className="font-semibold">Customer</span>”). This Agreement consists of the terms and conditions set forth below and any Order Form. The “<span className="font-semibold">Effective Date”</span> of this Agreement is the date which is the earlier of (a) Customer’s initial access to the Services through any online provisioning, registration or order process or (b) the Effective Date of the first Order Form. This Agreement will govern Customer’s initial purchase on the Effective Date as well as any future purchases made by Customer that reference this Agreement. Nexus Partners may modify this Agreement from time to time as permitted in Section 13.4 (Amendment).
                            </p>
                            <p className="mt-5">
                                ...
                                <ul className="mt-6">
                                    ...
                                    <li className="mt-5">
                                        <p><span className="font-semibold">1.3 “Documentation”</span>
                                            means the technical materials made available by Nexus Partners to Customer and/or its Users in hard copy or electronic form describing the use and operation of the Services.</p>
                                    </li>
                                    <li className="mt-5">
                                        <p>
                                            <span className="font-semibold">1.4 “Services”</span>
                                            Nexus Partners’s proprietary web-based products and services, along with downloadable desktop and mobile apps. Each Order Form will identify details of Customer’s Services subscription.
                                        </p>
                                    </li>
                                    <li className="mt-5">
                                        <p>
                                            ...
                                            means a document signed by both Parties identifying the Enterprise Services to be made available by Nexus Partners pursuant to this Agreement.
                                        </p>
                                    </li>
                                    <li className="mt-5">
                                        <p>
                                            ...
                                            means add-on modules made available within the Services. Packages and Components may be created by Nexus Partners, Customer or other third parties. Packages and Components created by Nexus Partners are supported as part of the Services. Nexus Partners will use reasonable efforts to support Customer’s use of Packages and Components created by third parties but disclaims all warranties as to such Packages and Components.
                                        </p>
                                    </li>
                                    <li className="mt-5">
                                        <p>
                                    ...
                                    <li className="mt-5">
                                        <p>
                                            ...
                                            means Nexus Partners’s SaaS product, web design software, tools, along with downloadable desktop and mobile apps. Each Order Form will identify details of Customer’s subscription to the Services.
                                        </p>
                                    </li>
                                </ul>
                            </div>
