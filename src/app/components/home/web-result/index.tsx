          ...
          <div className='flex flex-col  lg:gap-16 gap-5'>
            <div className='flex flex-col items-center justify-center text-center gap-3'>
              <h2 className='max-w-6xl'>
                <TextGenerateEffect words={t('title')} duration={0.2} />
              </h2>
              <div>
                <h2>
            ...
            <div className='flex flex-col items-center justify-center text-center'>
              <h3 className='text-3xl md:text-5xl font-medium instrument-font italic text-purple_blue'>
                {t('title3')}
              </h3>
            </div>
            <div className='flex-col md:flex md:flex-row justify-center items-center text-center'>
              <div className='relative 2xl:px-24 px-16 md:py-8 py-4'>
                <h2 ref={ref} className='2xl:text-9xl md:text-7xl text-5xl'>
                  <sup>+</sup>
                  {inView ? <CountUp start={0} end={Number(t('stats.projects.number'))} duration={3} /> : '0'}
                </h2>
              ...
              <div className='relative 2xl:px-24 px-16 md:py-8 py-4'>
                <h2 className='2xl:text-9xl md:text-7xl text-5xl'>
                  <sup>+</sup>
                  {inView ? <CountUp start={0} end={Number(t('stats.clients.number'))} duration={3} /> : '0'}
                </h2>
                <p className='mt-2 text-dark_black/60 dark:text-white/60'>
              ...
              <div className='relative 2xl:px-24 px-16 md:py-8 py-4'>
                <h2 className='2xl:text-9xl md:text-7xl text-5xl'>
                  <sup>+</sup>
                  {inView ? <CountUp start={0} end={Number(t('stats.visibility.number'))} duration={3} /> : '0'}
                </h2>
                <p className='mt-2 text-dark_black/60 dark:text-white/60'>
                  {t('stats.visibility.label')}
                </p>
              </div>
            </div>
          </div>
