          ...
          <div className='flex flex-col gap-12'>
            <div className='flex flex-col justify-center items-center gap-10 lg:gap-16'>
              <motion.div
                ...
                <h2>
                  <TextGenerateEffect words={t('title1')} delay={0.4} />
                  <TextGenerateEffect
                    words={t('title2')}
                    delay={1}
            ...
            <div
              ...
              <div className='flex flex-col sm:flex-row gap-3 items-center'>
                <Link
                  href='/contact'
                  className='group gap-2 text-dark_black font-medium bg-brand-yellow rounded-full flex items-center lg:gap-4 py-2 pl-5 pr-2 border border-brand-yellow dark:border-opacity-50 hover:bg-transparent hover:text-white transition-all duration-200 ease-in-out'>
                  <span className='group-hover:translate-x-9 transform transition-transform duration-200 ease-in-out'>
                    {t('cta_banner.collaborate')}
                  </span>
                  <svg
                    width='32'
                    height='32'
